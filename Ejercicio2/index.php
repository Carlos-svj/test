<?php
    function sendEmail($mail_to, $mail_subject, $mail_body){
        ...
        $cURL_key = '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';
        $mail_from = 'cuentatest172@gmail.com';
    ...
    sendEmail("joan1smx@gmail.com","Hello World", "Hi, welcome to programming");